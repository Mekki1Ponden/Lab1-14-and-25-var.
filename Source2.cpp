...
void chosen_class(T* queue, int numQueue) {
	...
	while (flag)
	{
		...
		cout << "4 >> Arithmetic mean for elements with an odd ordinal numbers" << endl;
		cout << "8 >> Arithmetic mean for elements with an even ordinal number" << endl;
		...
		case 4: 
			...
			{
				system("cls");
				cout << "Arithmetic mean for elements with an odd ordinal numbers: " << queue[index].arithmeticMath() << endl;
				cout << "\n";
			}
			break;
		case 8:
			...
			{
				system("cls");
				cout << "Arithmetic mean for elements with an even ordinal numbers: " << queue[index].arithmeticMath2() << endl;
				cout << "\n";
			}
			break;
		case 5:
